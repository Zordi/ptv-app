...
class EphemeralKey extends StripeJsonModel {
  ...
  EphemeralKey.fromJson(Map<String, dynamic> json) {
    ...
    _createdAt = _created != null ? DateTime.fromMillisecondsSinceEpoch(_created!) : null;
    _expiresAt = _expires != null ? DateTime.fromMillisecondsSinceEpoch(_expires!) : null;
  }
    ...
    if (_shouldRefreshKey()) {
      ...
      try {
        ...
        final e = StripeAPIError('', {
          ...
          "Failed to retrieve ephemeralKey from server",
        });
      ...
      try {
        ...
        final e = StripeAPIError('', {
          StripeAPIError.FIELD_MESSAGE:
          "Failed to parse Ephemeral Key. Please return the response as it is as you received from the stripe server.",
        });
        throw StripeAPIException(e);
      }
