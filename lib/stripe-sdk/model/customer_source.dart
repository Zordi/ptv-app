...
class CustomerSource extends StripeJsonModel implements StripePaymentSource {
  ...
  factory CustomerSource.fromJson(Map<String, dynamic> json) {
    ...
    if (sourceObject == null) {
      return CustomerSource._internal(StripeCard(id: ''));
    } else {
  ...
  Source? asSource() {
    if (stripePaymentSource is Source) {
      return Source.fromJson((stripePaymentSource as Source).toMap());
    }
    return null;
  }
  ...
  StripeCard? asCard() {
    if (stripePaymentSource is StripeCard) {
      return StripeCard.fromJson((stripePaymentSource as StripeCard).toMap());
    }
    return null;
  }
