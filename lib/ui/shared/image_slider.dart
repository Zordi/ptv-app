    ...
    return Stack(children: <Widget>[
      ...
      Positioned(
        ...
        child: ElevatedButton(
          onPressed: () {
            // Handle the More button press here
            // You can show a menu or perform any action you desire
          ...
          style: ElevatedButton.styleFrom(
            ...
            primary: Colors.blueAccent[700], // Background color
          ),
          child: Text(
            'More',
            style: TextStyle(
      ...
      Align(
        ...
        child: Padding(
          padding: EdgeInsets.only(left: 16.0, bottom: 16.0), // Adjust the padding as needed
          child: Text(
            'More of Our Content',
            style: TextStyle(
              color: Colors.white,
