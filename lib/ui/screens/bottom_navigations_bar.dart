...
import 'package:nexthour/ui/screens/live_screen.dart';
              ...
              bottomNavigationBar: BottomNavigationBar(
                ...
                items: <BottomNavigationBarItem>[
                  BottomNavigationBarItem(
                      label: translate("Home_"), icon: SvgPicture.asset("assets/img_clock.svg")),
                  BottomNavigationBarItem(
                      label: translate("Search_"), icon: SvgPicture.asset("assets/img_clock.svg")),
                  BottomNavigationBarItem(
                      label: translate("Live"),
                      icon: SvgPicture.asset("assets/img-live.svg")),
                  BottomNavigationBarItem(
                      label: translate("Download_"),
                      icon: SvgPicture.asset("assets/img_arrowdown.svg")),
                  BottomNavigationBarItem(
                      label: translate("Profile"), icon: SvgPicture.asset("assets/img_user.svg")),
                ],
