...
// user name
  ...
  Widget profileImage() {
    var userDetails =
    Provider.of<UserProfileProvider>(context, listen: false).userProfileModel!;
    return Column(
      children: <Widget>[
        Container(
  ...
  Widget MenuItem({required String title, required Widget trailingWidget, required VoidCallback onTap}) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 16),
      child: GestureDetector(
        onTap: onTap, // Call the provided callback when the menu item is tapped
        child: Row(
            ...
            userDetails.active == "1" || userDetails.active == 1
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return InkWell(
                    child: "${screenList[index].id + 1}" == '$screenCount'
                        ? Column(
                      children: <Widget>[
                        Container(
                          height: 70.0,
