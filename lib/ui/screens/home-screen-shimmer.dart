      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Heading1(translate("Artist_"), widget.loading, type: "Actor"),
            SizedBox(
              height: 15.0,
            ),
            FadeTransition(
            ...
            Heading1(
                translate("Top_Movies___TV_Series"), widget.loading, type: "Top"),
            SizedBox(
              height: 15.0,
            ),
            FadeTransition(
            ...
            Heading1(translate("TV_Series"), widget.loading, type: "TV"),
            FadeTransition(
              opacity: _fadeInFadeOut,
              child: TvSeriesList(
                type: DatumType.T,
            ...
            Heading1(translate("Movies_"), widget.loading, type: "Mov"),
            FadeTransition(
              opacity: _fadeInFadeOut,
              child: MoviesList(
                type: DatumType.M,
